...
eur_dir=os.path.join(main_dir, "data/europeennes")
path = os.path.join(eur_dir, "candidats_results.parquet") # path to Data file (in repo parent folder)
...
data
#%%
data.to_parquet(os.path.join(eur_dir, "agg_elections_99-24_commune.parquet"))
#%%
data=pd.read_parquet(os.path.join(eur_dir,"agg_elections_99-24_commune.parquet"))
data
...
# Download it before
mapping=pd.read_csv(os.path.join(eur_dir,"nuances.csv"))
mapping
#%%
...
pd.read_csv(os.path.join(eur_dir, "libelle_to_nuance.csv")).sort_values(by="Tendance").to_csv(os.path.join(eur_dir,"tendances_sort.csv"), index=False)
#%%
mapp=pd.read_csv(os.path.join(eur_dir,"libelle_to_nuance.csv"))
mapp
#%%
...
#%%
data.to_parquet(os.path.join(eur_dir,"save_after_mappings.parquet"))
#%%
data=pd.read_parquet(os.path.join(eur_dir,"save_after_mappings.parquet"))
data
...
data
#%%
data.to_parquet(os.path.join(eur_dir,"cleaned_df.parquet"))
#%%
data=pd.read_parquet(os.path.join(eur_dir,"cleaned_df.parquet"))
data
...
df_sum
#%%
df_sum.to_parquet(os.path.join(eur_dir,"df_sum.parquet"))
#%%
df_sum=pd.read_parquet(os.path.join(eur_dir,"df_sum.parquet"))
df_sum
...
#%%
df.to_parquet(os.path.join(eur_dir,"df_europeennes.parquet"))
#%%
df=pd.read_parquet(os.path.join(eur_dir,"df_europeennes.parquet"))
df

#%% Download it before
general_results=pd.read_parquet(os.path.join(eur_dir,"general_results.parquet"))
general_results
#%% BASIC MODIFS
...
#%%
general_results.to_parquet(os.path.join(eur_dir,"general_results_clean.parquet"))
#%%
general_results=pd.read_parquet(os.path.join(eur_dir,"general_results_clean.parquet"))
general_results
...
df=df.rename(columns={"exprimes":"pvoteppar","Inscrits":"inscrits","index_commune":"codecommune","id_election":"annee"})
df["type"]=[2 for k in range(len(df))]
df
#%%
df.to_parquet(os.path.join(eur_dir,"data_europeennes_final.parquet"))
#%%
pd.read_parquet(os.path.join(eur_dir,"data_europeennes_final.parquet"))